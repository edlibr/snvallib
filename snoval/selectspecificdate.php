...
<!--   <div class="Subjects listing"> -->
  	...
  	<table class='centerx'>
		...
		<h1 style='text-align: center;'> Select a Date from the Dropdown to <br>Show Books Added on a Specific Date</h1>
		<br>
...
<br>
  		<form action="booksondate.php" method="post"> 	

  		<select class='date' name="loc[]"required> 
		  <option style="text-align: center;" value="">Select Here for Books Added On</option>
